...
//console.log(util1.createUser({username: 'Guillerman2001', email:'guillerman2001@gmail.com', password:'pixiboton', name:'Guillermo', role:'admin'}));
//COMPROBAR OTRA  VEZ MAS TARDE
...
//console.log(util1.modifyPassword('guillerman2001@gmail.com', '!Pixiboton012345'));
...
//PREGUNTAR.
console.log(util1.checkUser());//En PHP no funciona
//console.log(util1.cloneTemplate(5));
//PREGUNTAR.
console.log(util1.createTemplate({})); //En PHP funciona
//PREGUNTAR.
console.log(util1.uploadTemplate(445));//En PHP no funciona
